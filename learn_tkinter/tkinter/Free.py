# // -> Floor Division (hasil pembagian angka 1 dan angka 2 dimana menghasilkan aangka bulat)
class Hero ():
...
class HeroStreght (Hero):
    ...
    def __init__ (self,name):
        ...
        self.attPower_pool = [0,20,40,60,80,100]
        self.armor_pool = [0,2,4,6,8]
        self.levelUp = 1

angga = HeroIntelgance("angga")
castell = HeroStreght("Castellani")
angga.show_info()

angga.attack(castell)
angga.show_info()