...
class Calculator:
    def __init__(self,master):
        ...
        self.entry_value = ''
        Entry(width=20,bg='#fff',font=('Times New Roman', 30), textvariable=self.equation).place(x=0,y=0)

        Button(width=11, height=4, text=")", relief='flat', bg='white', command=lambda:self.show(')')).place(x=0, y=52)
        Button(width=11, height=4, text="(", relief='flat', bg='white', command=lambda:self.show('(')).place(x=90, y=52)
        Button(width=11, height=4, text="%", relief='flat', bg='white', command=lambda:self.show('%')).place(x=180, y=52)
        ...
        Button(width=11, height=4, text="/", relief='flat', bg='white', command=lambda:self.show('/')).place(x=270, y=52)
